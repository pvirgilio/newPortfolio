    ...
    <>
      <section className="bg-[#070707] py-20">
        <div className="container mx-auto lg:px-0 ">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-center text-white text-base sm:text-lg 2xl:text-xl mt-5 max-w-xl mx-auto">
      ...
      >
        <div className="w-full h-full backdrop-blur-[2px]">
          <div className="container lg:px-0 max-w-2xl mx-auto h-full flex flex-col items-center justify-center text-center ">
            <h3 className="text-2xl sm:text-3xl 2xl:text-4xl text-white font-bold ">
              Eleve sua produtividade. Comece a transformar suas ideias hoje
              mesmo.
            </h3>
            <p className="text-gray-200  text-base sm:text-lg 2xl:text-xl mt-5">
            ...
            <Button
              ...
              as={Link}
              href="/#contact"
              className="bg-[#AD2B49] !p-6 text-white font-medium text-base sm:text-lg 2xl:text-xl mt-10"
            >
              Entre em contato
            </Button>
          </div>
